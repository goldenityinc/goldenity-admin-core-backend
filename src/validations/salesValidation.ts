...
export const createSaleSchema = z.object({
  ...
  transactionType: z.string().trim().min(1).optional().nullable(),
  ...
  mechanicName: z.string().trim().min(1).optional().nullable(),
  mechanicCommission: decimalLikeSchema.optional().nullable(),
